...
public class Ex01_String {
	...
	public static void lastIndexOf() {
		...
		int idx2 = slogan.lastIndexOf("김민서");
	...
	public static void startsWith() {
		...
		// startsWith
		// 문자열이 지정된 정규식 패턴(Regular Expression)으로 시작되면 true 반환
	...
	public static void contains() {
		...
		String email = "parkhy0sh1n@naver.com";
	...
	public static void format() {
		...
		System.out.println(String.format("%5s", str));  	// %5s : 5자리로 표시하시오. 문자는 오른쪽에 표시하시오.
		System.out.println(String.format("%-5s", str));  	// %-5s : 5자리로 표시하시오. 문자는 왼쪽에 표시하시오.
